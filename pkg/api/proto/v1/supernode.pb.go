...
var file_supernode_proto_goTypes = []interface{}{
	(*Supernode)(nil),                 // 0: com.pojtinger.felix.gon2n.Supernode
	(*SupernodeManaged)(nil),          // 1: com.pojtinger.felix.gon2n.SupernodeManaged
	(*SupernodeManagerListArgs)(nil),  // 2: com.pojtinger.felix.gon2n.SupernodeManagerListArgs
	(*SupernodeManagedId)(nil),        // 3: com.pojtinger.felix.gon2n.SupernodeManagedId
	(*SupernodeManagerListReply)(nil), // 4: com.pojtinger.felix.gon2n.SupernodeManagerListReply
}
var file_supernode_proto_depIdxs = []int32{
	1, // 0: com.pojtinger.felix.gon2n.SupernodeManagerListReply.SupernodesManaged:type_name -> com.pojtinger.felix.gon2n.SupernodeManaged
	0, // 1: com.pojtinger.felix.gon2n.SupernodeManager.Create:input_type -> com.pojtinger.felix.gon2n.Supernode
	2, // 2: com.pojtinger.felix.gon2n.SupernodeManager.List:input_type -> com.pojtinger.felix.gon2n.SupernodeManagerListArgs
	3, // 3: com.pojtinger.felix.gon2n.SupernodeManager.Get:input_type -> com.pojtinger.felix.gon2n.SupernodeManagedId
	3, // 4: com.pojtinger.felix.gon2n.SupernodeManager.Delete:input_type -> com.pojtinger.felix.gon2n.SupernodeManagedId
	3, // 5: com.pojtinger.felix.gon2n.SupernodeManager.Create:output_type -> com.pojtinger.felix.gon2n.SupernodeManagedId
	4, // 6: com.pojtinger.felix.gon2n.SupernodeManager.List:output_type -> com.pojtinger.felix.gon2n.SupernodeManagerListReply
	1, // 7: com.pojtinger.felix.gon2n.SupernodeManager.Get:output_type -> com.pojtinger.felix.gon2n.SupernodeManaged
	3, // 8: com.pojtinger.felix.gon2n.SupernodeManager.Delete:output_type -> com.pojtinger.felix.gon2n.SupernodeManagedId
...
func (c *supernodeManagerClient) Create(ctx context.Context, in *Supernode, opts ...grpc.CallOption) (*SupernodeManagedId, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felix.gon2n.SupernodeManager/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supernodeManagerClient) List(ctx context.Context, in *SupernodeManagerListArgs, opts ...grpc.CallOption) (*SupernodeManagerListReply, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felix.gon2n.SupernodeManager/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supernodeManagerClient) Get(ctx context.Context, in *SupernodeManagedId, opts ...grpc.CallOption) (*SupernodeManaged, error) {
	...
	err := c.cc.Invoke(ctx, "/com.pojtinger.felix.gon2n.SupernodeManager/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supernodeManagerClient) Delete(ctx context.Context, in *SupernodeManagedId, opts ...grpc.CallOption) (*SupernodeManagedId, error) {
	out := new(SupernodeManagedId)
	err := c.cc.Invoke(ctx, "/com.pojtinger.felix.gon2n.SupernodeManager/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SupernodeManager_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felix.gon2n.SupernodeManager/Create",
	}
...
func _SupernodeManager_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felix.gon2n.SupernodeManager/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SupernodeManager_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felix.gon2n.SupernodeManager/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SupernodeManager_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.pojtinger.felix.gon2n.SupernodeManager/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _SupernodeManager_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.pojtinger.felix.gon2n.SupernodeManager",
